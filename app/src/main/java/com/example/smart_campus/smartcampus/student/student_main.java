...
public class student_main extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.profile:
                Toast.makeText(student_main.this, "Profile is Selcted", Toast.LENGTH_SHORT).show();
                break;
            case R.id.Logout:
                userLogout();
                Toast.makeText(student_main.this, "Logout is Selected", Toast.LENGTH_SHORT).show();
                break;
            case R.id.about:
                Toast.makeText(student_main.this, "Smart Campus v1.0", Toast.LENGTH_SHORT).show();
                break;
        }
